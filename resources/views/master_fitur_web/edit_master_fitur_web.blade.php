...
{{-- Judul Halaman  --}}
@section('title', 'Edit Master Fitur Web')
...
@section('content')
  ...
  {{-- Halaman Show --}}
  @section('halaman', 'Edit Master Fitur Web')
  ...
  <div class="container">
    <div class="card shadow-sm mt-3 mb-3">
      <div class="card-body">
        ...
        <form action="{{route('edit__master-fitur')}}" method="POST">
          @csrf
          <input type="text" name="id_fitur" value="{{$data->id_fitur}}" hidden>
          ...
          <div class="form-input-dashboard">
            ...
            <input
              ...
              value="Rp {{number_format($data->harga)}}.00"
              name="harga_fitur"
          ...
          <div class="form-input-dashboard">
            ...
            <textarea required name="deskripsi_fitur" id="deskripsi_fitur" cols="30" rows="10">{{$data->deskripsi}}</textarea>
          </div>
